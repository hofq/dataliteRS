...
2. Connect the converter's RS-232 output directly to the controller bus (no RJ45 needed, or use the existing internal connector). You can either connect it to the first Controller or to the Ports of the RJ45 Jack.
3. Tap **5V from one of the display's internal power supply** to power the ESP32-C3 via its 5V pin (not USB-C). **Measure first!**
